...
{
    public partial class ClientInfoForm : Form,IChangedListener
    {
        ...
        private void ClientInfoForm_Load(object sender, EventArgs e)
        {
            if (bclient != null) 
            {
                ...
                dataGridView1.Columns[2].HeaderText = "客户类型";
                dataGridView1.Columns[3].HeaderText = "联系人";
                dataGridView1.Columns[4].HeaderText = "联系地址";
                dataGridView1.Columns[5].HeaderText = "邮政编码";
                dataGridView1.Columns[6].HeaderText = "联系电话";
                dataGridView1.Columns[7].HeaderText = "传真";
                dataGridView1.Columns[8].HeaderText = "备注";
                
            }
            this.btn_ok.Visible = false;
            this.btn_cancel.Visible = false;
            this.cb_clientType.SelectedIndex = 0;
        }
        /// <summary>
        /// 数据更新回调
        /// </summary>
        public void changed()
        {
            ...
            if( cb_clientType.SelectedIndex < 0 ){
                ...
                bclient.setGridView(this.dataGridView1,cb_clientType.SelectedIndex+1);
        ...
        private void cb_clientType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cb_clientType.SelectedIndex < 0)
            {
                bclient.setGridView(this.dataGridView1, 1);
